...
export default function ProjectCard({ title, slug, description, image, stacks, is_featured }: IProjectItem) {
  ...
  return (
    <Link href={`/projects/${slug}`}>
      <Card className="relative border dark:bg-neutral-800 border-neutral-200 dark:border-neutral-800 dark:bg-[#4949492e] backdrop-blur-lg lg:hover:scale-[102%] cursor-pointer">
        {is_featured && (

...
const ContactPreview = () => {
  ...
  return (
    <section className="space-y-5">
      ...
      <Card className="p-8 bg-neutral-50 border border-neutral-300 shadow-3xl ring-1 ring-black/5 dark:divide-neutral-800 dark:border-neutral-800 dark:bg-[#4949492e] backdrop-blur-lg rounded-xl space-y-4">
